...
const mapDispatchToProps = dispatch => ({
  ...
  postFeedback: (fisrtname, lastname, telnum, email,agree,contactType,message,feedId) => dispatch(postFeedback(fisrtname, lastname, telnum, email,agree,contactType,message,feedId)),
...
class Main extends Component
{
  ...
  render()
  {
    ...
    console.log("main component is invoked");
  return (
    <div>
      <Header/>
      <TransitionGroup>
